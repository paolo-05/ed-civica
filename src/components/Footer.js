...
const Footer = () => {
  return (
    <div>
      ...
      <div style={{ color: "#000", background: "var(--main-color)", textAlign:"center" }}>
        <div>
          <div className="container">
            <div className="row">
              <div className="col-sm">
                <h3 style={{color:"#178d8f"}}>
                  Sito web realizzato da Paolo Bianchessi, in collaborazione con
                  Mattia Belloni, Stefano Bona ed Erik Bonazzoli
                </h3>
              </div>
              <div className="col-sm" style={{ color: "#178d8f" }}>
                <Image src="https://www.galileicrema.edu.it/sites/default/files/logogalilei.png" fluid="true"/>
                Realizzato in <a href="https://www.galileicrema.edu.it/">I.I.S. Galileo Galilei</a>
              </div>
            </div>
          </div>
        </div>

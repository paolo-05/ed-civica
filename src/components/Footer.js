const Footer = () => {
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        ...
        <div style={{background: "var(--main-color)", color: "var(--text-color)",}}>
            <div >
                <div className="container">
                    <div className="row">
                        <div className="col-sm">
                            <h6>Sito web realizzato da Paolo Bianchessi, in collaborazione con Mattia Belloni, Stefano Bona ed Erik Bonazzoli</h6>
                        </div> 
                    </div>
                </div>
            </div>
